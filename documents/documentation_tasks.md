...
- **Пакет:** —
- **Статус:** не требуется — web не поддерживаем (решение Р-5); модель JS SDK использована как ориентир при проектировании
...
- **Пакет:** —
- **Статус:** не требуется — подключение web-библиотеки
