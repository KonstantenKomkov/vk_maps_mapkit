<!-- Источник: https://dev.vk.ru/ru/vkmaps/maps-mobile-sdk/ios -->
<!-- Снято: 2026-09-08 -->
...
- в появившемся окне введите адрес репозитория - [https://github.com/maps-mailru/maps-sdk-ios](https://vk.ru/away.php?to=https%3A%2F%2Fgithub.com%2Fmaps-mailru%2Fmaps-sdk-ios).
...
- cконфигурировать карту;
- yказать делегат карты.
...
`Geocoder` — компонент `MapsSDK` для прямого и обратного геокодирования. Для инициализации необходим `API_KEY`.
