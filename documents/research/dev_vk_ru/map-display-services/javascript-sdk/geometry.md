<!-- Источник: https://dev.vk.ru/ru/vkmaps/map-display-services/javascript-sdk/geometry -->
<!-- Снято: 2026-09-08 -->
...
Параметр метода — `input:``LngLatLike`. Массив из двух чисел или объект для преобразования, или объект `LngLat` для возврата.
...
Параметр метода — `input:``LngLatBoundsLike`. Массив из двух координат для преобразования или объект `LngLatBounds` для возврата.
...
Параметр метода — `lnglat:``LngLatLike`.
...
Параметр метода — `ne:``LngLatLike`. Установите северо-восточный угол ограничивающего прямоугольника.

### setSouthWest(sw)

Установите юго-западный угол ограничительной рамки.

Параметр метода — `ne:``LngLatLike`. Объект, описывающий юго-западный угол ограничивающего прямоугольника.
